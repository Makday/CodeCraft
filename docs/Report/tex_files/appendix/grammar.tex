...
\begin{lstlisting}[basicstyle=\small\ttfamily, breaklines=true, breakatwhitespace=false, escapeinside={(*}{*)}]
...
<string>            ::= "\"" <characters> "\""
<characters>        ::= (*$\varepsilon$*) | <character> <characters>
...
<space>             ::= " "
<optional_space>    ::= <space> | (*$\varepsilon$*)
