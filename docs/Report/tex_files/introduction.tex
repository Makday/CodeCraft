...
grammar and core language constructs, and to implement a complete toolchain spanning lexer,
parser, interpreter, and Minecraft integration.
...
The report is organized into three main chapters. Chapter 1 presents the domain analysis,
...
requirements and the formal BNF grammar. Chapter 3 covers language implementation, providing
a comprehensive account of the lexer, parser, interpreter, and Minecraft integration layers,
including the tick-based action execution model and multi-tick action architecture. The report
concludes with a summary of outcomes and directions for future work.
